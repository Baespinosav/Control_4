...
def poblar_bd(request):
    ...
    try:
        ...
        Vehiculo.objects.create(patente="01",categoria=Categoria.objects.get(idCategoria=1),  modelo="Comida de perro",descripcion='Comida para perros de 13kg',descs='SI',desco='NO', imagen="img/alimentoP1.jpg", precio=12990 )
        Vehiculo.objects.create(patente="02",categoria=Categoria.objects.get(idCategoria=1),  modelo="Comida de perro",descripcion='Comida para perros de 5 kg ',descs='SI',desco='NO', imagen="img/alimentoP2.jpg", precio=9990)
        Vehiculo.objects.create(patente="03",categoria=Categoria.objects.get(idCategoria=2),  modelo="Comida de gato",descripcion='Comdida para gatos de 13KG',descs='SI',desco='NO', imagen="img/alimentoG1.jpg", precio=12990)
        Vehiculo.objects.create(patente="04",categoria=Categoria.objects.get(idCategoria=2),  modelo="Comida de gato",descripcion='Comida para gatos de 5kg',descs='SI',desco='NO', imagen="img/alimentoG2.jpg", precio=9990)
        Vehiculo.objects.create(patente="05",categoria=Categoria.objects.get(idCategoria=3),  modelo="Comida de gato",descripcion='Correa para mascota',descs='SI',desco='NO', imagen="img/product-3.jpg", precio=4990)
